export const translations = {
    id: {
        ...
        contact: {
            title: 'Hubungi Saya',
            subtitle: 'Mari bekerja sama dalam proyek Anda berikutnya',
        ...
        music: {
            title: 'Musik Saya',
            subtitle: 'Nikmati lagu favorit saya',
    ...
    en: {
        ...
        about: {
            ...
            description: 'I am a passionate web developer focused on creating beautiful and functional digital experiences.',
        ...
        music: {
            title: 'My Music',
            subtitle: 'Enjoy my favorite tracks',
            playlist: 'Playlist',
            songs: 'songs',
