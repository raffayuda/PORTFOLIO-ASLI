					...
					>
						<div class="grid items-center gap-6 py-8 md:grid-cols-12 md:py-10">
							...
							<div class="flex items-center gap-3 md:col-span-2 md:justify-end">
								...
								{/if}
								<div class="flex h-9 w-9 items-center justify-center rounded-xl bg-primary/10 text-primary transition-all group-hover:bg-primary group-hover:text-primary-foreground">
